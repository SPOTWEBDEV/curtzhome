...
function insertNavbar(activePage) {
  ...
  <nav>
    <div style="max-width:1280px;margin:0 auto;padding:0 2rem;display:flex;align-items:center;justify-content:space-between;height:65px;">
      <a href="index.html" class="logo-text" style="color:var(--gold);font-size:1.45rem;text-decoration:none;letter-spacing:0.04em;">
        Curtz <span style="color:var(--cream);font-weight:300;">Home</span>
      </a>
      <div style="display:flex;gap:2.5rem;align-items:center;" id="desktopNav">
      ...
      <div style="display:flex;gap:0.8rem;align-items:center;">
        ...
        <a href="billing.html" class="btn-gold nav-dashboard" style="padding:0.5rem 1.2rem;font-size:0.75rem;display:none;">Dashboard</a>
        <button class="btn-outline nav-logout" style="padding:0.5rem 1.2rem;font-size:0.75rem;display:none;">Logout</button>
        <button id="menuToggle" style="background:none;border:none;cursor:pointer;flex-direction:column;gap:5px;display:none;">
